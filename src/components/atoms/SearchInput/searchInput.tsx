...
const SearchInput = ({
  ...
  return (
    <div
      className={twMerge(
        "flex w-[22.5rem] items-center rounded-sm border bg-gray-100 px-4 py-2 focus:border-black focus:ring-0",
        containerClassName
      )}
    >
      <SearchIcon />
      <input
        type="text"
        className={twMerge(
          "ml-2 w-[18.75rem] border-none bg-gray-100 text-sm text-gray-600 outline-none focus:ring-0",
