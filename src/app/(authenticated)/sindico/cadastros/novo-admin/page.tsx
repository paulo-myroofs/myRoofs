...
const NovoAdmin = () => {
  ...
  const handleForm = async (data: AddAptManagerForm) => {
    ...
    const aptManagerData = {
      ...
      positionOptions: data.ownerBasicInfo.positionOptions,
    ...
    >
      <div className="space-y-4">
        <div className="flex space-x-2">
          <button
          className="p-0"
          onClick={() => router.push("/sindico/cadastros")} 
          type="button"
          >
          <img src="/arrow_back.svg" alt="Voltar" />
          </button>
          <TitleAtom className="text-center"> Novo Administrador </TitleAtom>
        </div>
